...
export function ContactFormWidget({ lang, dict }: Props) {
 ...
 <h3 className="text-3xl lg:text-5xl font-display font-black text-white mb-6 relative z-10 uppercase tracking-tighter ">
 {isFr ? "MESSAGE TRANSMIS." : "MESSAGE TRANSMITTED."}
 </h3>
 
 <p className="text-slate-400 max-w-sm mx-auto relative z-10 text-lg font-light tracking-tight leading-relaxed">
 {isFr
 ...
 className="mt-12 text-[10px] font-black text-slate-500 hover:text-white uppercase tracking-[0.5em] transition-all border-b border-transparent hover:border-white pb-1 relative z-10"
 >
 ...
 <label htmlFor="firstName" className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] mb-1 group-hover/input:text-slate-950 transition-colors">
 ...
 className="h-14 bg-transparent border-t-0 border-r-0 border-l-0 border-b-2 border-slate-100 focus-visible:ring-0 focus-visible:border-slate-950 rounded-none px-0 text-xl font-black uppercase tracking-tighter transition-all placeholder:text-slate-400"
 required
 />
 </div>
 <div className="space-y-3 group/input">
 <label htmlFor="lastName" className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] mb-1 group-hover/input:text-slate-950 transition-colors">
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
 <div className="space-y-3 group/input">
 <label htmlFor="email" className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] mb-1 group-hover/input:text-slate-950 transition-colors">
 ...
 <div className="space-y-3 group/input">
 <label htmlFor="phone" className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] mb-1 group-hover/input:text-slate-950 transition-colors">
 ...
 <div className="space-y-3 group/input">
 <label htmlFor="subject" className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] mb-1 group-hover/input:text-slate-950 transition-colors">
 {dict.subject}
 </label>
 <Input
 id="subject"
 ...
 <div className="space-y-3 group/input">
 <label htmlFor="message" className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] mb-1 group-hover/input:text-slate-950 transition-colors">
 ...
 value={form.message}
 onChange={handleChange}
 className="w-full h-40 bg-transparent border-t-0 border-r-0 border-l-0 border-b-2 border-slate-100 focus-visible:outline-none focus:border-slate-950 px-0 py-4 text-xl font-light tracking-tight transition-all placeholder:text-slate-400 resize-none"
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.4em] leading-none">{dict.badges.secure}</span>
 </div>
 <div className="flex items-center gap-3 text-slate-500 group/badge">
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.4em] leading-none">{dict.badges.confidential}</span>
 </div>
 <div className="flex items-center gap-3 text-slate-500 group/badge">
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.4em] leading-none">{dict.badges.compliance}</span>
 </div>
 </div>

 {/* Urgent Link - Technical Industrial CTA */}
 <div className="pt-12 border-t border-slate-100 text-center">
 <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.4em] mb-6 ">{dict.urgent.text}</p>
 <div
 data-cal-link="stigmatech/30min"
 className="inline-flex items-center gap-6 text-[11px] font-black text-slate-500 hover:text-slate-950 transition-all cursor-pointer group uppercase tracking-[0.4em] "
 >
