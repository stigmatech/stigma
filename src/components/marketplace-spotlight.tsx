...
export function MarketplaceSpotlight({ lang, dictionary }: { lang: Locale; dictionary: any }) {
 ...
 <span className="text-[8px] font-black px-3 py-1 uppercase tracking-[0.2em] bg-slate-100 text-slate-400 group-hover:bg-slate-950 group-hover:text-white transition-all">
 {product.tag}
 </span>
 </div>
