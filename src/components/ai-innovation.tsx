...
export function AIInnovation({ lang, dictionary }: { lang: Locale; dictionary: any }) {
 ...
 <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[800px] bg-[radial-gradient(ellipse_at_top,rgba(255,255,255,0.02)_0%,transparent_70%)]"></div>
 </div>
 ...
 <h2 className="font-display text-4xl lg:text-6xl text-slate-950 tracking-tighter uppercase font-black leading-none max-w-4xl mx-auto">
 {dict.title}<br/>
 <span className="text-slate-200">AGENTIQUE</span>
 </h2>
 <p className="mt-6 text-lg text-slate-500 font-light max-w-xl mx-auto tracking-tight">
 {dict.description}
 </p>
 </div>
 ...
 <div
 key={i}
 className="group relative bg-white border border-slate-100 p-8 transition-all duration-700 hover:bg-slate-950 hover:border-slate-800 flex flex-col h-full shadow-sm hover:shadow-2xl"
 >
 ...
 <div className="absolute top-0 left-0 w-0 h-[2px] bg-blue-600 group-hover:w-full transition-all duration-700" />
 </div>
 ))}
 </div>
 </div>
 ...
 className="inline-flex items-center gap-4 bg-slate-950 text-white px-10 py-5 text-[10px] font-black uppercase tracking-[0.4em] transition-all hover:bg-blue-600 shadow-xl"
 >
