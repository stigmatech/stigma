...
export function NewsletterForm({ dictionary }: { dictionary: any }) {
 ...
 type="submit" 
 disabled={status === "loading" || status === "success"}
 className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-blue-600 rounded-none flex items-center justify-center hover:bg-blue-500 transition-colors disabled:opacity-50"
 >
 {status === "loading" ? (
