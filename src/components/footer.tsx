...
export function Footer({ lang, dictionary }: { lang: Locale; dictionary: any }) {
 return (
 <footer className="bg-slate-950 pt-24 pb-8 relative overflow-hidden">
 ...
 <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 mb-20 font-sans justify-between">

 {/* Branding and Contact */}
 <div className="lg:w-3/12 xl:w-1/4 space-y-8 shrink-0">
 ...
 {/* Links Sections Container */}
        <div className="lg:w-9/12 xl:w-3/4 flex flex-wrap justify-between gap-8 lg:gap-4 xl:gap-8">
 ...
 <h4 className="text-[11px] font-bold text-white uppercase tracking-[0.2em] mb-8">{dictionary.common.footer.pme}</h4>
 <ul className="space-y-4">
 <li>
 <Link href={`/${lang}/pme`} className="group flex items-center text-sm text-gray-400 hover:text-white transition-colors">
 <span className="material-symbols-outlined text-[14px] mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:block transition-all text-gray-400">arrow_right_alt</span>
 <span className="group-hover:translate-x-1 transition-transform duration-300">{dictionary.common.nav.pmeOverview}</span>
 </Link>
 </li>
 <li>
 <Link href={`/${lang}/pme#pricing`} className="group flex items-center text-sm text-gray-400 hover:text-white transition-colors">
 <span className="material-symbols-outlined text-[14px] mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:block transition-all text-gray-400">arrow_right_alt</span>
 <span className="group-hover:translate-x-1 transition-transform duration-300">{dictionary.common.nav.pmePlans}</span>
 </Link>
 </li>
 <li>
 <Link href={`/${lang}/pme/diagnostic`} className="group flex items-center text-sm text-gray-400 hover:text-white transition-colors">
 <span className="material-symbols-outlined text-[14px] mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:block transition-all text-gray-400">arrow_right_alt</span>
 <span className="group-hover:translate-x-1 transition-transform duration-300 font-bold text-white">{dictionary.common.nav.pmeDiagnostic}</span>
 </Link>
 </li>
 <li>
 <Link href={`/${lang}/pme#faq`} className="group flex items-center text-sm text-gray-400 hover:text-white transition-colors">
 <span className="material-symbols-outlined text-[14px] mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:block transition-all text-gray-400">arrow_right_alt</span>
 <span className="group-hover:translate-x-1 transition-transform duration-300">{dictionary.common.nav.pmeFaq}</span>
 </Link>
 </li>
 </ul>
 </div>
 ...
 <ul className="space-y-4">
 <li>
 <Link href={`/${lang}/products/ai-training/${getCourseSlug("ia-decouverte", lang)}`} className="group flex items-center text-sm text-gray-400 hover:text-white transition-colors">
 <span className="material-symbols-outlined text-[14px] mr-2 opacity-0 -ml-5 group-hover:opacity-100 transition-all text-gray-400">arrow_right_alt</span>
 <span className="group-hover:translate-x-1 transition-transform duration-300">{dictionary.common.footer.aiDiscovery}</span>
 </Link>
 </li>
 <li>
 <Link href={`/${lang}/products/ai-training/${getCourseSlug("ia-booster", lang)}`} className="group flex items-center text-sm text-gray-400 hover:text-white transition-colors">
 <span className="material-symbols-outlined text-[14px] mr-2 opacity-0 -ml-5 group-hover:opacity-100 transition-all text-gray-400">arrow_right_alt</span>
 <span className="group-hover:translate-x-1 transition-transform duration-300">{dictionary.common.footer.aiBooster}</span>
 </Link>
 </li>
 <li>
 <Link href={`/${lang}/products/ai-training/${getCourseSlug("microsoft-copilot", lang)}`} className="group flex items-center text-sm text-gray-400 hover:text-white transition-colors">
 <span className="material-symbols-outlined text-[14px] mr-2 opacity-0 -ml-5 group-hover:opacity-100 transition-all text-gray-400">arrow_right_alt</span>
 <span className="group-hover:translate-x-1 transition-transform duration-300">{dictionary.common.footer.msCopilot}</span>
 </Link>
 </li>
 <li>
 <Link href={`/${lang}/products/ai-training/${getCourseSlug("ia-performer", lang)}`} className="group flex items-center text-sm text-gray-400 hover:text-white transition-colors">
 <span className="material-symbols-outlined text-[14px] mr-2 opacity-0 -ml-5 group-hover:opacity-100 transition-all text-gray-400">arrow_right_alt</span>
 ...
 {/* Newsletter and Social */}
          <div className="min-w-[240px] xl:min-w-[280px] flex-none">
