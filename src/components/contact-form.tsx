...
export function ContactForm({ lang, dictionary, overrideDict, initialMessage, variant = "default"}: ContactFormProps) {
 ...
 <h2 className={`font-display text-5xl lg:text-7xl leading-[1.05] uppercase tracking-tighter ${isElite ? 'text-white font-black' : 'text-background-dark font-bold'}`}>
 {dict.title}
 </h2>
 ...
 <div className={`inline-flex items-center gap-4 p-5 border text-sm ${
