...
export function BookingSection({
 ...
 // Fallback for missing steps or values
 ...
 {[
 { label: values.client, icon: "person_check" },
 { label: values.results, icon: "trending_up" },
 { label: values.independent, icon: "verified_user" },
 { label: values.transparency, icon: "visibility" }
 ].map((item) => (
