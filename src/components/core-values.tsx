...
export function CoreValues({ dictionary }: { dictionary: any }) {
 ...
 const AUTOPLAY_DURATION = 8000;
  ...
  const testimonials = dictionary?.testimonials?.map((t: any, index: number) => {
    const images = [
      "/images/testimonials/security-director.png",
      "/images/testimonials/digital-transformation-manager.png",
      "/images/testimonials/operations-director.png"
    ];
    const logos = [
      "/Logos/Partners/MicroSoft.png",
      "/Logos/Partners/Acronis.png",
      "/Logos/Partners/sentinelOne.png"
    ];
    return {
      id: t.id || index + 1,
      quote: t.quote,
      ...
      role: t.role,
      company: t.company,
      image: images[index] || "/images/testimonials/security-director.png",
      logo: logos[index] || "/Logos/Partners/MicroSoft.png"
    };
  }) || [];
 ...
 <div className="w-full lg:w-[65%] relative flex flex-col p-10 sm:p-16 lg:py-12 lg:px-20 justify-center">
 ...
 >
 <div className="text-slate-400 font-mono text-[10px] tracking-[0.5em] mb-6 opacity-60 uppercase">{dict.clientImpact || "Impact Client"} // 0{activeTestimonial.id}</div>
 
 <h3 className="text-2xl sm:text-3xl lg:text-[2.25rem] font-black text-white leading-[1.15] tracking-tight mb-8 max-w-2xl">
