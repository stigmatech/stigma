...
export default async function SPMPage(props: {
 ...
 <Button asChild size="lg" className="rounded-none px-10 py-7 text-[10px] uppercase tracking-[0.3em] font-black bg-white text-slate-950 hover:bg-slate-100 transition-all border-none font-sans">
 ...
 <h2 className="text-5xl lg:text-7xl font-display font-black text-slate-950 uppercase tracking-tighter leading-none mb-10 ">
 {d.whatIsTitle}
 </h2>
 <p className="text-2xl text-slate-500 font-light leading-relaxed tracking-tight border-l-4 border-slate-100 pl-10 max-w-3xl mx-auto text-left font-sans">
 {d.whatIsText}
 </p>
 </div>
 </div>
 ...
 <span className="material-symbols-outlined text-[32px] text-slate-400 group-hover:text-white transition-colors uppercase font-sans">{f.icon}</span>
 </div>
 <div className="font-sans">
 <h3 className="text-2xl font-black text-slate-950 group-hover:text-white transition-colors uppercase tracking-tight mb-4 font-sans">
 {f.title}
 </h3>
 ...
 <div className="absolute bottom-0 left-0 w-0 h-1 bg-slate-950 group-hover:w-full transition-all duration-700 font-sans" />
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="font-sans">
 <h2 className="text-5xl lg:text-7xl font-display font-black uppercase tracking-tighter mb-12">{d.baselineTitle}</h2>
 <div className="space-y-12 font-sans">
 {d.baselineItems.map((item, i) => (
 <div key={i} className="group relative border-l-2 border-white/5 pl-8 hover:border-white transition-colors font-sans">
 <h4 className="text-2xl font-black uppercase tracking-tight mb-4 leading-tight group-hover:text-white transition-colors font-sans">{item.title}</h4>
 ...
 <div className="px-3 py-1 bg-white/10 border border-white/20 text-[9px] uppercase tracking-[0.3em] font-black text-white font-sans">{isFr ? "SPM Actif" : "SPM Active"}</div>
 ...
 <h4 className="text-3xl font-display font-black text-white uppercase tracking-tight mb-8 ">Drift Prevention</h4>
 <p className="text-xl text-slate-400 leading-relaxed font-light transition-colors group-hover:text-slate-200 font-sans">
 {lang === "fr"
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 mb-12 block font-sans">{isFr ? "SCAN DE PROTOCOLE DE DURCISSEMENT" : "HARDENING PROTOCOL SCAN"}</span>
