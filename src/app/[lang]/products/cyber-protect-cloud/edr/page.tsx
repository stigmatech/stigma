...
export default async function EDRPage(props: {
 ...
 return (
 <div className="min-h-screen bg-slate-950 selection:bg-slate-950/10 ">
 ...
 <section className="py-32 bg-white relative selection:bg-slate-950/10">
 ...
 <span className="material-symbols-outlined text-[32px] text-slate-400 group-hover:text-white transition-colors uppercase">{p.icon}</span>
 </div>
 <div>
 ...
 <div className="absolute bottom-0 left-0 w-0 h-1 bg-slate-950 group-hover:w-full transition-all duration-700" />
 </div>
 ))}
 </div>
 </div>
 ...
 <span className="text-white/40 font-black uppercase tracking-[0.5em] text-[9px] mb-6 block ">{isFr ? "CONFORMITÉ NIST" : "NIST COMPLIANCE"}</span>
 <h2 className="text-5xl lg:text-7xl font-display font-black uppercase tracking-tighter ">{d.nist.title}</h2>
 </div>
 ...
 <section className="py-32 bg-white relative overflow-hidden selection:bg-slate-950/10 font-sans">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 ...
 <div className="w-20 h-20 bg-white border border-slate-200 flex items-center justify-center shrink-0 group-hover:rotate-6 transition-all duration-700 group-hover:bg-slate-950 group-hover:border-slate-800 shadow-sm">
 <span className="material-symbols-outlined text-3xl text-slate-400 group-hover:text-white uppercase">{f.icon}</span>
 </div>
 <div>
 <h3 className="text-2xl font-black text-slate-950 group-hover:text-white uppercase tracking-tight mb-4 leading-tight">
 {f.title}
 </h3>
 ...
 <section className="py-32 bg-slate-950 text-white relative overflow-hidden border-t border-white/5 selection:bg-slate-950/10 font-sans">
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 mb-12 block ">{isFr ? "SÉCURISEZ VOS TERMINAUX" : "SECURE YOUR ENDPOINTS"}</span>
