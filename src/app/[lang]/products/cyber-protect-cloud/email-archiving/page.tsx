...
export default async function EmailArchivingPage(props: {
 ...
 <section className="py-32 bg-slate-50 border-y border-slate-100 relative selection:bg-slate-950/10">
 ...
 <h2 className="text-5xl lg:text-7xl font-display font-black uppercase tracking-tighter ">{d.archivingVsBackup.title}</h2>
 ...
 <h3 className="text-4xl font-black uppercase tracking-tighter leading-none mb-4">{d.archivingVsBackup.left.title}</h3>
 <p className="text-white text-sm font-black uppercase tracking-widest">{d.archivingVsBackup.left.subtitle}</p>
 </div>
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.4em] text-white/40 mb-4 block animate-pulse">{isFr ? "COUCHE DE CONFORMITÉ" : "COMPLIANCE LAYER"}</span>
 <h3 className="text-4xl font-black uppercase tracking-tighter leading-none mb-4">{d.archivingVsBackup.right.title}</h3>
 ...
 <li key={i} className="flex gap-4 text-blue-100/70 group-hover:text-white transition-colors ">
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 mb-12 block font-sans">{isFr ? "AUDIT DE REGISTRE PERMANENT" : "PERMANENT RECORD AUDIT"}</span>
