...
export default async function EmailSecurityPage(props: {
 ...
 <div>
 <h2 className="text-5xl lg:text-7xl font-display font-black uppercase tracking-tighter mb-12">{d.whyStigma.title}</h2>
 ...
 <div className="px-3 py-1 bg-white/10 border border-white/20 text-[9px] uppercase tracking-[0.3em] font-black text-white animate-pulse">Inbound Scan</div>
 ...
 <h4 className="text-3xl font-display font-black text-white uppercase tracking-tight mb-8 ">X-Ray Intelligence</h4>
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 mb-12 block font-sans">{isFr ? "RÉSILIENCE TOTALE DE LA MESSAGERIE" : "TOTAL EMAIL RESILIENCE"}</span>
