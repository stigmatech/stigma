...
export default async function XDRPage(props: {
 ...
 <span className="text-white/40 font-black uppercase tracking-[0.5em] text-[9px] mb-6 block font-sans">{lang === "fr" ? "ALIGNEMENT SUR LES CADRES" : "FRAMEWORK ALIGNMENT"}</span>
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-violet-400 mb-12 block ">{isFr ? "CONSOLE UNIFIÉE XDR" : "XDR UNIFIED CONSOLE"}</span>
