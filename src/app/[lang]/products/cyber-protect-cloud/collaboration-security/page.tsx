...
export default async function CollaborationSecurityPage(props: {
 ...
 <span className="material-symbols-outlined text-[32px] text-slate-400 group-hover:text-white transition-colors uppercase">{f.icon}</span>
 </div>
 <div>
 ...
 <div>
 <h2 className="text-5xl lg:text-7xl font-display font-black uppercase tracking-tighter mb-12">{d.pillars.title}</h2>
 <div className="space-y-12">
 {d.pillars.items.map((item, i) => (
 <div key={i} className="group relative border-l-2 border-white/5 pl-8 hover:border-white transition-colors">
 <h4 className="text-2xl font-black uppercase tracking-tight mb-4 leading-tight group-hover:text-white transition-colors">{item.title}</h4>
 ...
 <div className="px-3 py-1 bg-white/10 border border-white/20 text-[9px] uppercase tracking-[0.3em] font-black text-white">Teams Active</div>
 ...
 <h4 className="text-3xl font-display font-black text-white uppercase tracking-tight mb-8 ">360-Degree Protection</h4>
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 mb-12 block font-sans">SECURE COLLABORATION SYNC</span>
