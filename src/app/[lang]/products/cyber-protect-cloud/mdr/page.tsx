...
export default async function MDRPage(props: {
 ...
 <span className="material-symbols-outlined text-[32px] text-slate-400 group-hover:text-white transition-colors">{item.icon}</span>
 </div>
 <div>
 ...
 <h3 className="text-3xl font-black text-slate-950 uppercase tracking-tighter mb-6 leading-tight">
 ...
 <div className="absolute top-4 right-4 bg-slate-800 text-white text-[9px] font-black px-4 py-1 tracking-[0.3em] uppercase">{isFr ? "RECOMMANDÉ" : "RECOMMENDED"}</div>
 <h3 className="text-3xl font-black text-white uppercase tracking-tighter mb-6 leading-tight">
 ...
 <div className="absolute top-0 right-0 w-8 h-8 border-r border-t border-slate-800 group-hover:border-slate-400 transition-colors"></div>
 </div>
 </div>
 </div>
 </section>
 ...
 <span className="material-symbols-outlined text-4xl text-slate-400 group-hover:text-white">{b.icon}</span>
 </div>
 <h3 className="text-2xl font-black text-slate-950 uppercase tracking-tighter mb-4 leading-tight font-sans">
 {b.title}
 </h3>
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 mb-12 block ">{isFr ? "DÉFENSE SOC ÉLITE" : "ELITE SOC DEFENSE"}</span>
