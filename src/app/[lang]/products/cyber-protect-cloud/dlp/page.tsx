...
export default async function DLPPage(props: {
 ...
 <p className="text-2xl text-slate-500 font-light leading-relaxed tracking-tight border-l-4 border-slate-100 pl-10 max-w-3xl mx-auto text-left">
 {d.whatIsText}
 </p>
 </div>
 </div>
 ...
 <span className="material-symbols-outlined text-[32px] text-slate-400 group-hover:text-white transition-colors">{f.icon}</span>
 </div>
 <div>
 ...
 <h2 className="text-5xl lg:text-7xl font-display font-black uppercase tracking-tighter ">{d.howItWorks.title}</h2>
 ...
 <div className="text-5xl font-display font-black text-white/10 group-hover:text-slate-400 transition-colors mb-8">0{i + 1}</div>
 <h3 className="text-2xl font-black uppercase tracking-tight mb-4 leading-tight">{step.title}</h3>
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-950 mb-6 block ">{isFr ? "PRÉPARATION RÉGLEMENTAIRE" : "REGULATORY READINESS"}</span>
 <h2 className="text-5xl lg:text-7xl font-display font-black text-slate-950 uppercase tracking-tighter leading-none mb-10 ">
 {d.compliance.title}
 </h2>
 ...
 <div className="text-slate-950 font-black text-[10px] uppercase tracking-widest mb-3 group-hover:translate-x-1 transition-transform">{item.label}</div>
 ...
 <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rotate-45 translate-x-16 translate-y-[-16px]"></div>
 <h4 className="text-2xl font-display font-black text-white uppercase tracking-tight mb-8 ">DLP PLATFORM FACT</h4>
 <p className="text-xl text-slate-400 leading-relaxed font-light transition-colors group-hover:text-slate-200">
 {lang === "fr"
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 mb-12 block ">{isFr ? "FLUX DE DONNÉES SÉCURISÉS" : "SECURE DATA FLOWS"}</span>
