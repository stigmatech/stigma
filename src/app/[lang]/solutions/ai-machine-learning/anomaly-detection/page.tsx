...
export async function generateMetadata(props: {
    ...
    const isFr = lang === "fr";
    return {
        title: isFr ? "Détection d'Anomalies | IA Entreprise | Stigma Technologies" : "Anomaly Detection | Enterprise AI | Stigma Technologies",
        description: isFr
            ? "Identifiez en temps réel les comportements aberrants dans vos flux de données pour prévenir la fraude et anticiper les pannes."
            : "Identify aberrant behaviors in real-time across your data streams to prevent fraud and anticipate failures.",
        openGraph: {
            title: isFr ? "Détection d'Anomalies | Stigma Technologies" : "Anomaly Detection | Stigma Technologies",
            description: isFr ? "Sécurisez vos opérations avec l'apprentissage automatique." : "Secure your operations with machine learning.",
            url: `https://stigmatech.ca/${lang}/solutions/ai-machine-learning/anomaly-detection`,
            siteName: "Stigma Technologies",
            type: "website",
        },
        alternates: { canonical: `https://stigmatech.ca/${lang}/solutions/ai-machine-learning/anomaly-detection` },
    };
}

export default async function AnomalyDetectionPage(props: {
    params: Promise<{ lang: string }>;
}) {
    const params = await props.params;
    const lang = params.lang as Locale;
    const dictionary = await getDictionary(lang);
    const dict = dictionary.services.anomalyDetection;
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="relative">
                                <div className="aspect-[4/3] w-full bg-gray-100 relative overflow-hidden group rounded-none border border-gray-200">
                                    <Image
                                        src="/images/anomaly-detection-v3.png"
