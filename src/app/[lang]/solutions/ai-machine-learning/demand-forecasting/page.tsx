...
export async function generateMetadata(props: {
    ...
    const isFr = lang === "fr";
    return {
        title: isFr ? "Prévision de la Demande | IA Prédictive | Stigma Technologies" : "Demand Forecasting | Predictive AI | Stigma Technologies",
        description: isFr
            ? "Anticipez les fluctuations du marché et optimisez votre chaîne d'approvisionnement en utilisant l'apprentissage automatique."
            : "Anticipate market fluctuations and optimize your supply chain by using machine learning.",
        openGraph: {
            title: isFr ? "Prévision de la Demande IA | Stigma Technologies" : "AI Demand Forecasting | Stigma Technologies",
            description: isFr ? "Passez de la réaction à l'anticipation." : "Move from reaction to anticipation.",
            url: `https://stigmatech.ca/${lang}/solutions/ai-machine-learning/demand-forecasting`,
            siteName: "Stigma Technologies",
            type: "website",
        },
        alternates: { canonical: `https://stigmatech.ca/${lang}/solutions/ai-machine-learning/demand-forecasting` },
    };
}

export default async function DemandForecastingPage(props: {
    params: Promise<{ lang: string }>;
}) {
    const params = await props.params;
    const lang = params.lang as Locale;
    const dictionary = await getDictionary(lang);
    const dict = dictionary.services.demandForecasting;
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="relative">
                                <div className="aspect-[4/3] w-full bg-gray-100 relative overflow-hidden group rounded-none border border-gray-200">
                                    <Image
                                        src="/images/demand-forecasting-hero.png"
                                        alt="Demand Forecasting AI"
                                        fill
                        ...
                        <div className="group relative bg-white/5 backdrop-blur-sm border border-white/10 p-1 rounded-none overflow-hidden hover:border-blue-500/50 transition-colors duration-500">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                                <div className="relative aspect-video lg:aspect-auto overflow-hidden">
                                    <Image
                                        src="/images/demand-forecasting-hero.png"
                                        alt="Demand Forecasting Case Study"
                                        fill
                                        className="object-cover group-hover:scale-105 transition-transform duration-700"
                                    />
                                ...
                                <div className="p-8 lg:p-12 flex flex-col justify-center">
                                    <h3 className="text-2xl lg:text-3xl font-bold text-white mb-6 leading-tight">Predictive Supply Chain for Pharmaceutical Distribution</h3>
                                    <p className="text-gray-400 mb-8 leading-relaxed">AI-driven forecasting predicting vaccine demand with 92% accuracy, reducing medicine waste by 30% and improving regional drug availability across multi-state distribution networks.</p>

                                    <div className="grid grid-cols-2 gap-6 mb-10">
                                        <div>
                                            <div className="text-2xl font-bold text-blue-400 mb-1">92%</div>
                                            <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Forecast Accuracy</div>
                                        </div>
                                        <div>
                                            <div className="text-2xl font-bold text-blue-400 mb-1">30%</div>
                                            <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Waste reduction</div>
                                        </div>
                                    </div>
                                    ...
                                    <Button asChild className="bg-white text-surface-dark hover:bg-blue-50 w-full md:w-fit rounded-none px-8 py-6 uppercase tracking-wider text-xs font-bold transition-all group/btn">
                                        <a href={`/${lang}/case-studies/pharma-demand-forecasting`} className="flex items-center gap-2">
                                            Read Full Report
