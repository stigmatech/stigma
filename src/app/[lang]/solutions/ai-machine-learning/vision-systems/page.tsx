...
export async function generateMetadata(props: {
    ...
    const isFr = lang === "fr";
    return {
        title: isFr ? "Systèmes de Vision | IA Industrielle | Stigma Technologies" : "Computer Vision Systems | Industrial AI | Stigma Technologies",
        description: isFr
            ? "Automatisez l'inspection, la classification et la surveillance grâce à des réseaux de neurones convolutionnels de pointe."
            : "Automate inspection, classification, and monitoring using cutting-edge convolutional neural networks.",
        openGraph: {
            title: isFr ? "Systèmes de Vision | Stigma Technologies" : "Vision Systems | Stigma Technologies",
            description: isFr ? "Des yeux infatigables pour vos opérations." : "Tireless eyes for your operations.",
            url: `https://stigmatech.ca/${lang}/solutions/ai-machine-learning/vision-systems`,
            siteName: "Stigma Technologies",
            type: "website",
        },
        alternates: { canonical: `https://stigmatech.ca/${lang}/solutions/ai-machine-learning/vision-systems` },
    };
}

export default async function VisionSystemsPage(props: {
    params: Promise<{ lang: string }>;
}) {
    const params = await props.params;
    const lang = params.lang as Locale;
    const dictionary = await getDictionary(lang);
    const dict = dictionary.services.visionSystems;
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="relative">
                                <div className="aspect-[4/3] w-full bg-gray-100 relative overflow-hidden group rounded-none border border-gray-200">
                                    <Image
                                        src="/images/vision-systems-hero.png"
                                        alt="Computer Vision Systems AI"
                                        fill
                        ...
                        <div className="group relative bg-white/5 backdrop-blur-sm border border-white/10 p-1 rounded-none overflow-hidden hover:border-blue-500/50 transition-colors duration-500">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                                <div className="relative aspect-video lg:aspect-auto overflow-hidden">
                                    <Image
                                        src="/images/vision-systems-hero.png"
                                        alt="Vision Inspection Case Study"
                                        fill
                                        className="object-cover group-hover:scale-105 transition-transform duration-700"
                                    />
                                ...
                                <div className="p-8 lg:p-12 flex flex-col justify-center">
                                    <h3 className="text-2xl lg:text-3xl font-bold text-white mb-6 leading-tight">High-Precision AI Inspection for Aerospace Components</h3>
                                    <p className="text-gray-400 mb-8 leading-relaxed">Implementing multi-spectral computer vision to detect micro-fractures in critical engine components with 99.8% accuracy, significantly reducing recall risks and operational costs.</p>

                                    <div className="grid grid-cols-2 gap-6 mb-10">
                                        <div>
                                            <div className="text-2xl font-bold text-blue-400 mb-1">99.8%</div>
                                            <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Detection Rate</div>
                                        </div>
                                        <div>
                                            <div className="text-2xl font-bold text-blue-400 mb-1">400%</div>
                                            <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Speed Increase</div>
                                        </div>
                                    </div>
                                    ...
                                    <Button asChild className="bg-white text-surface-dark hover:bg-blue-50 w-full md:w-fit rounded-none px-8 py-6 uppercase tracking-wider text-xs font-bold transition-all group/btn">
                                        <a href={`/${lang}/case-studies/aerospace-vision-inspection`} className="flex items-center gap-2">
                                            Read Full Report
