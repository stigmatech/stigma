...
export default async function AIMachineLearning(props: {
 ...
 <section className="py-32 sm:py-40 bg-white relative selection:bg-slate-950/10">
 ...
 <span className="material-symbols-outlined text-[32px] text-slate-400 group-hover:text-white transition-colors">{feature.icon}</span>
 </div>
 <div>
 ...
 <div>
 <h3 className="text-2xl font-black text-slate-950 group-hover:text-white transition-colors uppercase tracking-tight mb-6 ">
 {item.sector}
 </h3>
 <p className="text-sm text-slate-500 group-hover:text-slate-400 leading-relaxed font-light ">
 "{item.case}"
 </p>
 </div>
 </div>
 ...
 <span className="text-white/40 font-black uppercase tracking-[0.5em] text-[9px] mb-6 block ">{shared.processTag || (lang === 'fr' ? "FRAMEWORK DE DÉPLOIEMENT" : "DEPLOYMENT FRAMEWORK")}</span>
 ...
 <h2 className="text-3xl lg:text-5xl font-display font-medium text-slate-950 leading-tight mb-16 tracking-tight">
 ...
 <h4 className="text-lg font-black text-slate-950 uppercase tracking-tight mb-4 flex items-start gap-4 ">
 ...
 <ContactForm lang={lang} dictionary={dictionary} overrideDict={dictionary.services.aiMachineLearning.contactForm} variant="elite" />
 </main>
