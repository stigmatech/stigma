...
export async function generateMetadata(props: {
    ...
    const isFr = lang === "fr";
    return {
        title: isFr ? "Formation IA Entreprise | Stigma Technologies" : "Enterprise AI Training | Stigma Technologies",
        description: isFr
            ? "Équipez vos dirigeants et vos équipes de connaissances pratiques pour exploiter les outils d'IA générative."
            : "Equip your leaders and teams with practical knowledge to leverage generative AI tools.",
        openGraph: {
            title: isFr ? "Formation IA en Entreprise | Stigma Technologies" : "Enterprise AI Training | Stigma Technologies",
            description: isFr ? "Devenez une organisation propulsée par l'IA." : "Become an AI-powered organization.",
            url: `https://stigmatech.ca/${lang}/solutions/ai-machine-learning/ai-training`,
            siteName: "Stigma Technologies",
            type: "website",
        },
        alternates: { canonical: `https://stigmatech.ca/${lang}/solutions/ai-machine-learning/ai-training` },
    };
}
...
export default async function AiTrainingPage(props: {
    ...
    const dict = dictionary.services.aiTraining;
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="relative">
                                <div className="aspect-[4/3] w-full bg-gray-100 relative overflow-hidden group rounded-none border border-gray-200">
                                    <Image
                                        src="/images/ai-training-hero.png"
