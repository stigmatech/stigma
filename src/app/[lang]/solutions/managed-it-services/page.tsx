...
export default async function ManagedITServices(props: {
 ...
 <div className="flex items-center text-[10px] font-black uppercase tracking-[0.3em] text-slate-950 group-hover:text-blue-400 transition-all duration-300">
 {shared.learnMore}
 ...
 <div className="absolute bottom-0 left-0 w-0 h-1 bg-slate-950 group-hover:w-full transition-all duration-700 shadow-[0_0_15px_rgba(255,255,255,0.1)]" />
 </Link>
 ))}
 </div>
 </div>
 ...
 <span className="material-symbols-outlined text-[60px] text-slate-200 mb-10 block ">format_quote</span>
 <h2 className="text-3xl md:text-4xl font-display font-black text-slate-950 leading-tight mb-12 tracking-tighter">
 ...
 <p className="text-slate-500 font-bold text-xs mt-2 uppercase tracking-widest">{dict.testimonial.role}</p>
