...
export default async function ManagedCybersecurity(props: {
 ...
 <Button asChild size="lg" className="rounded-none px-12 h-16 text-[10px] uppercase tracking-[0.3em] font-black bg-white text-slate-950 hover:bg-slate-100 transition-all border-none">
 <Link href={`/${lang}/evaluations/cyber-security`}>
 {dict.cta}
 </Link>
 </Button>
 ...
 <span className="text-white/40 font-black uppercase tracking-[0.5em] text-[9px] mb-6 block ">{shared.processTag || (lang === 'fr' ? "FRAMEWORK DE DÉFENSE" : "DEFENSE FRAMEWORK")}</span>
 ...
 <ContactForm lang={lang} dictionary={dictionary} overrideDict={dictionary.services.managedCybersecurity.contactForm} variant="elite" />
 </main>
