...
export default async function EventsPage(props: { params: Promise<{ lang: string }> }) {
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-amber-400 mb-12 block ">{isFr ? "PROTOCOLE D'ENGAGEMENT" : "ENGAGEMENT PROTOCOL"}</span>
 <h2 className="text-5xl lg:text-7xl font-display font-black uppercase tracking-tighter leading-none mb-12 ">
 {isFr ? "Ne manquez jamais une session." : "Never miss a session."}
 </h2>
 <p className="text-slate-400 text-xl font-light mb-16 max-w-2xl mx-auto tracking-tight">
 {isFr 
 ...
 <a 
 href={`/${lang}/contact`}
 className="inline-flex items-center justify-center gap-6 bg-white text-slate-950 px-12 py-8 text-[11px] font-black uppercase tracking-[0.4em] hover:bg-slate-100 transition-all font-sans shadow-2xl"
 >
