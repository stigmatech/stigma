...
export default async function InsightsPage(props: {
 ...
 <span className="bg-slate-950/90 backdrop-blur-md px-3 py-1 text-[9px] font-black tracking-[0.2em] uppercase text-white border border-white/10 ">
 {resource.category}
 </span>
 <span className="bg-amber-500/90 backdrop-blur-md px-3 py-1 text-[9px] font-black tracking-[0.2em] uppercase text-slate-950 self-start ">
 {resource.type}
 </span>
 </div>
 <Image
 ...
 <h3 className="text-2xl font-black font-display text-slate-950 group-hover:text-amber-600 transition-colors uppercase tracking-tighter leading-none line-clamp-2">
 {resource.title[lang === "fr" ? "fr" : "en"]}
 </h3>
 
 <p className="text-slate-500 font-light text-base line-clamp-3 leading-relaxed tracking-tight border-l-2 border-slate-100 pl-6 py-2 group-hover:border-amber-200 transition-colors">
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-amber-400 mb-12 block ">{isFr ? "FEUILLE DE ROUTE TACTIQUE" : "TACTICAL ROADMAP"}</span>
 ...
 <Link href={`/${lang}/contact`} className="inline-flex items-center justify-center bg-white text-slate-950 px-10 py-6 text-[10px] font-black uppercase tracking-[0.3em] hover:bg-slate-100 transition-all font-sans ">
