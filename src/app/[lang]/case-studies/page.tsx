...
export default async function CaseStudiesPage(props: {
 ...
 const dict = (dictionary as any).caseStudies;
 const isFr = lang === "fr";
 ...
 <section className="bg-slate-950 text-white pt-32 pb-20 relative overflow-hidden">
 ...
 <h2 className="text-5xl lg:text-7xl font-display font-black text-slate-950 uppercase tracking-tighter mb-8">{isFr ? "Portfolio Tactique" : "Tactical Portfolio"}</h2>
 </div>
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-amber-400 mb-12 block font-sans ">{isFr ? "PROTOCOLE DE PERFORMANCE" : "PERFORMANCE PROTOCOL"}</span>
