...
export default async function Blog(props: {
 ...
 const dict = (dictionary as any).blog;
 const isFr = lang === "fr";
 ...
 <section className="bg-slate-950 text-white pt-32 pb-32 relative overflow-hidden">
 ...
 <div className="flex items-center gap-3 text-[9px] font-black text-slate-400 uppercase tracking-[0.3em] leading-none">
 ...
 <h3 className="text-2xl font-black font-display text-slate-950 group-hover:text-amber-600 transition-colors uppercase tracking-tighter leading-none">
 {t(article.title)}
 </h3>
 </Link>
 
 <p className="text-slate-500 font-light text-base leading-relaxed tracking-tight line-clamp-3 font-sans ">
 {t(article.excerpt)}
 </p>
 ...
 className="inline-flex items-center text-[10px] font-black text-slate-950 group-hover:text-amber-600 transition-all uppercase tracking-[0.4em] leading-none"
 >
